...
namespace FB {
    ...
    public:
        ...
        /// Note that this call will add Content-Type and content-Length headers.
        /// Note that you can hold onto the ptr to the request but you don't have to -- it will be
        /// cleaned up automatically when the request finishes.
        ///
        /// @code
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// @fn public static FB::SimpleStreamHelperPtr FB::SimpleStreamHelper::AsyncPostWithHeader(const FB::BrowserHostPtr& host, const FB::URI& uri, const std::string& header, const std::string& postdata, const HttpCallback& callback, const bool cache = true, const size_t bufferSize = 128*1024)
        ///
        /// @brief  Starts an asynchronous HTTP post request with custom headers
        ///
        /// Call this static method to make an asyncronous HTTP post request through the browser with
        /// custom headers. The last header should end with a new line.
        /// Note that you, most likely, need at leat a Content-Type and Content-Length header.
        /// Note that you can hold onto the ptr to the request but you don't have to -- it will be
        /// cleaned up automatically when the request finishes.
        ///
        /// @code
        /// void FBTestPluginAPI::postURL(const std::string& url, const std::string& header, const std::string& postdata, concst const FB::JSObjectPtr& callback)
        /// {
        ///    FB::SimpleStreamHelper::AsyncPost(m_host, FB::URI::fromString(url), header, postdata,
        ///        boost::bind(&FBTestPluginAPI::getURLCallback, this, callback, _1, _2, _3, _4));
        /// }
        ///
        /// void FBTestPluginAPI::getURLCallback(const FB::JSObjectPtr& callback, bool success,
        ...
        /// @param  host        const FB::BrowserHostPtr&   BrowserHostPtr to use to create the stream
        /// @param  uri         const FB::URI&              URI to request
        /// @param  header      const std::string&          Custom headers
        /// @param  postdata    const std::string&          Post data to send
        /// @param  callback    const HttpCallback &        Function to call with the response      
        /// @param  cache       const bool                  true if cache can be used
        /// @param  bufferSize  const size_t                Specifies the size of the buffer to use internally
        ...
        /// @see FB::URI
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        static FB::SimpleStreamHelperPtr AsyncPostWithHeader(const FB::BrowserHostPtr& host, const FB::URI& uri, const std::string& header, const std::string& postdata, const HttpCallback& callback,
            bool cache = true, size_t bufferSize = 128*1024);
